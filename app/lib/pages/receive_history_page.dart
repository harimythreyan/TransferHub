...
import 'package:transfer_hub_app/widget/dialogs/file_info_dialog.dart';
import 'package:transfer_hub_app/widget/dialogs/history_clear_dialog.dart';
...
class ReceiveHistoryPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: basicTransferHubAppbar(t.receiveHistoryPage.title),
