...
import 'package:transfer_hub_app/config/refena.dart';
import 'package:transfer_hub_app/config/theme.dart';
import 'package:transfer_hub_app/pages/home_page.dart';
import 'package:transfer_hub_app/pages/home_page_controller.dart';
...
import 'package:transfer_hub_app/provider/network/server/server_provider.dart';
import 'package:transfer_hub_app/provider/network/webrtc/signaling_provider.dart';
import 'package:transfer_hub_app/provider/persistence_provider.dart';

// [FOSS_REMOVE_START]
import 'package:transfer_hub_app/provider/purchase_provider.dart';
...
import 'package:transfer_hub_app/provider/tv_provider.dart';
import 'package:transfer_hub_app/provider/window_dimensions_provider.dart';
import 'package:transfer_hub_app/rust/api/logging.dart' as rust_logging;
import 'package:transfer_hub_app/rust/frb_generated.dart';
import 'package:transfer_hub_app/util/i18n.dart';
import 'package:transfer_hub_app/util/native/autostart_helper.dart';
import 'package:transfer_hub_app/util/native/cache_helper.dart';
import 'package:transfer_hub_app/util/native/content_uri_helper.dart';
import 'package:transfer_hub_app/util/native/context_menu_helper.dart';
import 'package:transfer_hub_app/util/native/cross_file_converters.dart';
import 'package:transfer_hub_app/util/native/device_info_helper.dart';
...
import 'package:transfer_hub_app/util/native/tray_helper.dart';
import 'package:transfer_hub_app/util/rhttp.dart';
import 'package:transfer_hub_app/util/ui/dynamic_colors.dart';
import 'package:transfer_hub_app/util/ui/snackbar.dart';
