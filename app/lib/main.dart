...
import 'package:transfer_hub_app/config/init.dart';
import 'package:transfer_hub_app/config/init_error.dart';
...
import 'package:transfer_hub_app/widget/watcher/life_cycle_watcher.dart';
import 'package:transfer_hub_app/widget/watcher/shortcut_watcher.dart';
import 'package:transfer_hub_app/widget/watcher/tray_watcher.dart';
import 'package:transfer_hub_app/widget/watcher/window_watcher.dart';
  ...
  runApp(
    RefenaScope.withContainer(
      ...
      child: TranslationProvider(
        child: const TransferHubApp(),
      ),
    ),
  );
}

class TransferHubApp extends StatelessWidget {
  const TransferHubApp();
          ...
          onChangedState: (AppLifecycleState state) {
            switch (state) {
              ...
              case AppLifecycleState.detached:
                ...
                // https://github.com/TransferHub/TransferHub/issues/1568
